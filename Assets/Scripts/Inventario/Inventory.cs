...
public class Inventory : Interactable {
  ...
  //  public GameObject distractorRadio;
  ...
  public  Image[] slotsArmas;
    ...
    public static List<Items> inventarioEstatico;
   ...
   public int energia;
    ...
    public bool inventAbierto = false;
    public bool seleccionarIt = false;
    public bool comer = false;
    public bool sonidoRadio = false;
    public bool recogerOb = false;
    // bool started = false;
    //private int cont = 0;
     ...
     void Update()
    {
        ...
        GestionDias.cantidadControlZ = usosControl;
    ...
    public void PulsarRadio()
    {
        for (int i = 0; i < myInventory.Count; i++)
        {
            ...
            if (myInventory[i].cantidad >= 1 && myInventory[i].id == 7)
            {
                ...
                Instantiate(radio, jugador.transform.position + jugador.transform.forward + jugador.transform.right, Quaternion.identity).SetActive(true);
  ...
  /*  public void AsignarSpriteCorrespondiente()
    {
       ...
       public void ActualizarCanvasInventario()
       {
        ...
        for (int i = 0; i < myInventory.Count; i++)
        {
            ...
            if (myInventory[i].id == 0)
            {
                slotsArmas[0].sprite = Resources.Load<Sprite>("Palo");//myInventory[i].itemSprite;
                break;
            }
        ...
        for (int i = 0; i < myInventory.Count; i++)
        {
            ...
            {
                slotsArmas[1].sprite = Resources.Load<Sprite>("Piedra");
                break;
            }
        ...
        for (int i = 0; i < myInventory.Count; i++)
        {
            ...
            {
                 slotsArmas[2].sprite = Resources.Load<Sprite>("Clavos");
                break;
            }
        ...
        for (int i = 0; i < myInventory.Count; i++)
        {
            ...
            {
                slotsArmas[3].sprite =Resources.Load<Sprite>("Cuerda");
                break;
            }
        ...
        for (int i = 0; i < myInventory.Count; i++)
        {
            ...
            {
                slotsConsumibles[0].sprite = Resources.Load<Sprite>("Lata");
                slotsConsumibles[0].transform.GetChild(0).GetComponent<Text>().text = myInventory[i].cantidad.ToString();
        ...
        for (int i = 0; i < myInventory.Count; i++)
        {
            ...
            {
                slotsConsumibles[1].sprite = Resources.Load<Sprite>("PiedraEspecial");
                slotsConsumibles[1].transform.GetChild(0).GetComponent<Text>().text = myInventory[i].cantidad.ToString();
        ...
        for (int i = 0; i < myInventory.Count; i++)
        {
            ...
            {
                slotsConsumibles[3].sprite = Resources.Load<Sprite>("Tarta");
                slotsConsumibles[3].transform.GetChild(0).GetComponent<Text>().text = myInventory[i].cantidad.ToString();
        ...
        for (int i = 0; i < myInventory.Count; i++)
        {
            ...
            {
                slotsConsumibles[5].sprite = Resources.Load<Sprite>("Radio");
                slotsConsumibles[5].transform.GetChild(0).GetComponent<Text>().text = myInventory[i].cantidad.ToString();
