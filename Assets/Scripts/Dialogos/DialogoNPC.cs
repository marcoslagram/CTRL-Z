...
public class DialogoNPC : Interactable {
 ...
 public string[] oracionConverNPC1;
    ...
    public GameObject canvasEconomía;
  ...
  /*  public GameObject dialogoCanvas;
    ...
    void Start () {
        ...
        intro = this.gameObject.GetComponent<VideoPlayer>();
    ...
    */
     ...
     void Update()
    {
        ...
        if (GestionDias.dia == 1 && tiempoDia.tiempo >= 359.5f && tiempoDia.tiempo<=360f && !sigueJuego && !salieronDialog)
           {

            

            if (intro.frame < Convert.ToInt64(intro.frameCount) && !canvasPausa.activeInHierarchy)
            {
                intro.Play();
            }
            ...
            if (intro.isPlaying)
            {
                ...
                canvasEconomía.SetActive(false);
             ...
             if(intro.frame >= Convert.ToInt64(intro.frameCount) || Input.GetKeyDown(KeyCode.C))
            {
                canvasInicio.SetActive(false);
                canvasMapa.SetActive(true);
                canvasEconomía.SetActive(true);
    ...
    public void OnTriggerEnter(Collider other)
    {
        ...
        debugg.DebuggingText("Pulsa E para hablar con el Gato");
        motorDialogo.botonPuls = true;
       // motorDialogo.botonPuls = false;
    }
    ...
    {   dialogo.SetActive(false);
        ...
        if (motorDialogo.finalConversacionGato)
        {
