...
public class MovimientoJugador : MonoBehaviour {
    ...
    private void DesplazamientoNormal()
    {
      ...
      // Vector3 movement = new Vector3(0, 0, velocidad) * Time.deltaTime;
        if (Input.GetKey(KeyCode.W))  //cuando pulsas W va hacia adelante
        {
            myPlayer.MovePosition(transform.position + (new Vector3(0, 0, velocidad) * Time.deltaTime));
        ...
        {
            myPlayer.MovePosition(transform.position + (new Vector3(-velocidad, 0, 0) * Time.deltaTime));
    ...
    private void Correr()
    {
        ...
        {
            myPlayer.MovePosition(transform.position + (new Vector3(0, 0, velocidadCarrera) * Time.deltaTime));
        ...
        {
            myPlayer.MovePosition(transform.position + (new Vector3(velocidadCarrera, 0, 0) * Time.deltaTime));
